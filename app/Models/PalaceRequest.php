...
class PalaceRequest extends Model
{
    ...
    protected $fillable = ['enterprise_id', 'user_id', 'guest_id', 'palace_service_id', 'room_id', 'request_number', 'description', 'metadata', 'requested_for', 'estimated_price', 'status', 'confirmed_at', 'cancelled_at', 'cancellation_reason'];
    ...
    public function palaceService()
    {
        return $this->belongsTo(PalaceService::class);
    }
