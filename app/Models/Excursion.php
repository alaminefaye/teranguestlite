...
class Excursion extends Model
{
    ...
    protected $fillable = ['enterprise_id', 'name', 'type', 'description', 'image', 'price_adult', 'price_child', 'duration_hours', 'departure_time', 'included', 'not_included', 'min_participants', 'max_participants', 'status', 'is_featured', 'display_order', 'is_active'];
