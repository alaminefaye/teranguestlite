...
class SpaReservation extends Model
{
    ...
    protected $fillable = ['enterprise_id', 'user_id', 'guest_id', 'spa_service_id', 'room_id', 'reservation_date', 'reservation_time', 'special_requests', 'price', 'status', 'confirmed_at', 'cancelled_at'];
