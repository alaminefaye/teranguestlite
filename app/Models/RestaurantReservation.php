...
class RestaurantReservation extends Model
{
    ...
    protected $fillable = ['enterprise_id', 'user_id', 'restaurant_id', 'room_id', 'reservation_date', 'reservation_time', 'number_of_guests', 'special_requests', 'status', 'confirmed_at', 'cancelled_at'];
