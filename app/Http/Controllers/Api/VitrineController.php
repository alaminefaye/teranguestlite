        ...
        return response()->json([
            ...
            'data' => $excursions->map(function ($excursion) {
                return [
                    ...
                    'price_adult_eur' => $excursion->price_adult_eur,
                    'price_child_eur' => $excursion->price_child_eur,
                    'formatted_price_adult' => $excursion->formatted_price_adult,
                    'formatted_price_child' => $excursion->formatted_price_child,
        ...
        try {
            ...
            foreach ($rooms as $room) {
                try {
                    ...
                    return response()->json([
                        'success' => false,
                        'message' => 'rooms_debug_room_failure',
                        'debug' => [
            ...
            return response()->json([
                'success' => false,
                'message' => 'rooms_debug_endpoint_failure',
                'debug' => [
                    'error' => $e->getMessage(),
                ],
            ], 500);
