...
<div class="rounded-lg border border-gray-200 bg-white p-6 shadow-theme-sm dark:border-gray-800 dark:bg-gray-900">
    <form action="{{ route('dashboard.enterprise-announcements.update', $announcement) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                @if($announcement->poster_path)
                    <img src="{{ asset('storage/' . $announcement->poster_path) }}" alt="Affiche" class="h-24 w-auto rounded-md mb-2 border border-gray-200 dark:border-gray-700">
            ...
            <div class="flex items-center">
                <p class="text-sm text-gray-500 dark:text-gray-400">👁 <strong>{{ number_format($announcement->view_count) }}</strong> vue(s)</p>
            </div>
        </div>
        ...
        <div class="mt-8 flex items-center gap-4">
            ...
            <a href="{{ route('dashboard.enterprise-announcements.index') }}" class="inline-flex items-center px-6 py-2 border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 rounded-md hover:bg-gray-50 dark:hover:bg-gray-800">Annuler</a>
        </div>
    </form>
</div>
@endsection
