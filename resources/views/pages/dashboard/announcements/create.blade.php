    ...
    <form action="{{ route('dashboard.announcements.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">JPEG, PNG, WebP, GIF – max 20 Mo. Au moins une affiche ou vidéo requise.</p>
            ...
            <div>
                ...
                <input type="file" name="video" id="video" accept=".mp4,.webm,.mov,.ogv"
                    class="w-full rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 px-4 py-2 text-gray-800 dark:text-white/90">
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">MP4, WebM, MOV, OGV – max 20 Mo. Audio désactivé par défaut dans l'app.</p>
