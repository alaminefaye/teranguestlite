...
<div class="mb-6">
    ...
    <h1 class="text-title-md2 font-semibold text-gray-900 dark:text-white/90">Ajouter un article</h1>
</div>

<div class="rounded-lg border border-gray-200 bg-white p-6 shadow-theme-sm dark:border-gray-800 dark:bg-gray-900">
    <form action="{{ route('dashboard.amenity-categories.items.store', $category) }}" method="POST">
        @csrf
        ...
        <div class="space-y-4">
            <div>
                ...
                <input type="text" name="name" id="name" value="{{ old('name') }}" required placeholder="ex. Savon, Shampooing..."
