...
@section('content')
    <div class="mb-6">
        <div class="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 mb-4">
            ...
            <span>/</span>
            <a href="{{ route('dashboard.excursions.show', $excursion) }}"
                class="hover:text-brand-500">{{ $excursion->name }}</a>
            <span>/</span>
            <span>Modifier</span>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="type" id="type" required
                        class="w-full rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 px-4 py-2 text-gray-800 dark:text-white/90 focus:border-brand-500 focus:ring-brand-500">
                        <option value="cultural" {{ old('type', $excursion->type) == 'cultural' ? 'selected' : '' }}>Culturel
                        </option>
                        <option value="adventure" {{ old('type', $excursion->type) == 'adventure' ? 'selected' : '' }}>
                            Aventure</option>
                        <option value="relaxation" {{ old('type', $excursion->type) == 'relaxation' ? 'selected' : '' }}>
                            Détente</option>
                        <option value="city_tour" {{ old('type', $excursion->type) == 'city_tour' ? 'selected' : '' }}>Tour de
                            ville</option>
                    </select>
                ...
                <div>
                    ...
                    <input type="number" name="duration_hours" id="duration_hours"
                        value="{{ old('duration_hours', $excursion->duration_hours) }}" required min="1"
                        class="w-full rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 px-4 py-2 text-gray-800 dark:text-white/90 focus:border-brand-500 focus:ring-brand-500">
                ...
                <div>
                    ...
                    <input type="text" name="departure_time" id="departure_time"
                        value="{{ old('departure_time', $excursion->departure_time) }}" placeholder="ex: 09:00"
                        class="w-full rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 px-4 py-2 text-gray-800 dark:text-white/90 focus:border-brand-500 focus:ring-brand-500">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="schedule_description" id="schedule_description" rows="3"
                        class="w-full rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 px-4 py-2 text-gray-800 dark:text-white/90 focus:border-brand-500 focus:ring-brand-500"
                        placeholder="ex: Départ 09h00, pause déjeuner 12h30-14h, retour 18h">{{ old('schedule_description', $excursion->schedule_description) }}</textarea>
                ...
                <div>
                    ...
                    <input type="number" name="price_adult" id="price_adult"
                        value="{{ old('price_adult', $excursion->price_adult) }}" required min="0" step="0.01"
                        class="w-full rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 px-4 py-2 text-gray-800 dark:text-white/90 focus:border-brand-500 focus:ring-brand-500">
                ...
                <div>
                    ...
                    <input type="number" name="price_child" id="price_child"
                        value="{{ old('price_child', $excursion->price_child) }}" min="0" step="0.01"
                        class="w-full rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 px-4 py-2 text-gray-800 dark:text-white/90 focus:border-brand-500 focus:ring-brand-500">
                ...
                <div>
                    ...
                    <input type="text" name="children_age_range" id="children_age_range"
                        value="{{ old('children_age_range', $excursion->children_age_range) }}"
                ...
                <div>
                    ...
                    <input type="number" name="min_participants" id="min_participants"
                        value="{{ old('min_participants', $excursion->min_participants) }}" required min="1"
                        class="w-full rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 px-4 py-2 text-gray-800 dark:text-white/90 focus:border-brand-500 focus:ring-brand-500">
                ...
                <div>
                    ...
                    <input type="number" name="max_participants" id="max_participants"
                        value="{{ old('max_participants', $excursion->max_participants) }}" min="1"
                        class="w-full rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 px-4 py-2 text-gray-800 dark:text-white/90 focus:border-brand-500 focus:ring-brand-500">
                ...
                <div>
                    ...
                    <select name="status" id="status"
                        class="w-full rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 px-4 py-2 text-gray-800 dark:text-white/90 focus:border-brand-500 focus:ring-brand-500">
                        <option value="available" {{ old('status', $excursion->status) == 'available' ? 'selected' : '' }}>
                            Disponible</option>
                        <option value="unavailable" {{ old('status', $excursion->status) == 'unavailable' ? 'selected' : '' }}>Indisponible</option>
                        <option value="seasonal" {{ old('status', $excursion->status) == 'seasonal' ? 'selected' : '' }}>
                            Saisonnier</option>
                    </select>
                ...
                <div>
                    ...
                    <input type="number" name="display_order" id="display_order"
                        value="{{ old('display_order', $excursion->display_order) }}" min="0"
                        class="w-full rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 px-4 py-2 text-gray-800 dark:text-white/90 focus:border-brand-500 focus:ring-brand-500">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="description" id="description" rows="5"
                        class="w-full rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 px-4 py-2 text-gray-800 dark:text-white/90 focus:border-brand-500 focus:ring-brand-500">{{ old('description', $excursion->description) }}</textarea>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="included" id="included" rows="3"
                        class="w-full rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 px-4 py-2 text-gray-800 dark:text-white/90 focus:border-brand-500 focus:ring-brand-500">{{ old('included', is_array($excursion->included) ? implode("\n", $excursion->included) : '') }}</textarea>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="not_included" id="not_included" rows="2"
                        class="w-full rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 px-4 py-2 text-gray-800 dark:text-white/90 focus:border-brand-500 focus:ring-brand-500">{{ old('not_included', is_array($excursion->not_included) ? implode("\n", $excursion->not_included) : '') }}</textarea>
                ...
                @if($excursion->image)
                    <div class="md:col-span-2">
                        ...
                        <img src="{{ asset('storage/' . $excursion->image) }}" alt="{{ $excursion->name }}"
                ...
                <div class="md:col-span-2">
                    <label for="image"
                        class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">{{ $excursion->image ? 'Changer l\'image' : 'Image' }}</label>
