...
<div class="mb-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-2">
            <a href="{{ route('dashboard.spa-services.edit', $service) }}" class="inline-flex items-center px-4 py-2 bg-brand-500 text-white rounded-md hover:bg-brand-600 dark:bg-brand-600 dark:hover:bg-brand-700 text-sm">Modifier</a>
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
    ...
    <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-theme-sm dark:border-gray-800 dark:bg-gray-900">
        ...
        <p class="text-lg text-gray-800 dark:text-white/90">{{ $service->duration_text }}</p>
        ...
        @if($service->is_featured)
            <span class="inline-flex items-center gap-1 text-sm font-medium text-brand-600 dark:text-brand-400 mt-2">★ Populaire</span>
        @endif
    </div>
</div>

<div class="mt-6">
    <a href="{{ route('dashboard.spa-services.index') }}" class="inline-flex items-center px-6 py-2 border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 rounded-md hover:bg-gray-50 dark:hover:bg-gray-800">← Retour à la liste</a>
</div>
@endsection
