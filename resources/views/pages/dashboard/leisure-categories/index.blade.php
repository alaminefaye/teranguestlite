    ...
    @forelse($categories as $category)
        <div class="rounded-lg border border-gray-200 bg-white p-4 shadow-theme-sm dark:border-gray-800 dark:bg-gray-900">
            ...
            <div class="flex items-center gap-2 mt-3 flex-wrap">
                ...
                <form action="{{ route('dashboard.leisure-categories.destroy', $category) }}" method="POST" onsubmit="return confirm('Supprimer cette catégorie et toutes ses activités ?');" class="inline">
                    @csrf
                    @method('DELETE')
