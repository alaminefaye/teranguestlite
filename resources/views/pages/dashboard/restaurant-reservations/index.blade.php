            ...
            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                @forelse($reservations as $r)
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50">
                        ...
                        <td class="px-4 py-3">
                            <x-action-buttons
                                :showRoute="route('dashboard.restaurant-reservations.show', $r)"
                                :editRoute="$r->status !== 'cancelled' ? route('dashboard.restaurant-reservations.edit', $r) : null"
                                :cancelRoute="$r->status !== 'cancelled' ? route('dashboard.restaurant-reservations.cancel', $r) : null"
