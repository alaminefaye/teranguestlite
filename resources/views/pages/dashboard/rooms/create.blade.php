...
<div class="mb-6">
    ...
    <h1 class="text-title-md2 font-semibold text-gray-900 dark:text-white/90">Créer une chambre / un tarif</h1>
    ...
    <form action="{{ route('dashboard.rooms.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="amenities_text" id="amenities_text" rows="4" placeholder="Un élément par ligne&#10;Ex. Tarif journalier&#10;Prestations incluses selon formule"
                ...
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Chaque ligne devient un badge ou une information dans l'app.</p>
