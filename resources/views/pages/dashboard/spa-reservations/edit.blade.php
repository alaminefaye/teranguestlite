...
<div class="mb-6">
    <div class="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 mb-4">
        <a href="{{ route('dashboard.spa-reservations.index') }}" class="hover:text-brand-500">Réservations Spa</a>
        <span>/</span>
        <a href="{{ route('dashboard.spa-reservations.show', $reservation) }}" class="hover:text-brand-500">Détail</a>
        <span>/</span>
        <span>Modifier</span>
    </div>
    <h1 class="text-title-md2 font-semibold text-gray-900 dark:text-white/90">Modifier la réservation spa</h1>
</div>
...
<div class="rounded-lg border border-gray-200 bg-white p-6 shadow-theme-sm dark:border-gray-800 dark:bg-gray-900">
    <form action="{{ route('dashboard.spa-reservations.update', $reservation) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="mt-6 flex gap-2">
            ...
            <a href="{{ route('dashboard.spa-reservations.show', $reservation) }}" class="px-4 py-2 border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 rounded-md hover:bg-gray-50 dark:hover:bg-gray-800">Annuler</a>
        </div>
    </form>
</div>
@endsection
