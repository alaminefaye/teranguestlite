    ...
    <form action="{{ route('guest.restaurants.reserve', $restaurant) }}" method="POST">
        ...
        <div class="space-y-4">
            <div class="rounded-lg bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 p-4">
                ...
                <input type="text" name="client_code" value="{{ old('client_code') }}" maxlength="20" placeholder="Ex: 123456 (reçu à l'enregistrement)" class="w-full rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 px-4 py-3 text-gray-800 dark:text-white/90">
